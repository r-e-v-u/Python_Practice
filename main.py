...
class Food:
    ...
    #Main Program options available to Admin and Users
    def def_main(self):
    ...
    Operations : Add Food Items, Edit Food Items, View Menu
    '''
    def def_Admin(self):
    ...
    '''
    IN = username and password of username
    operatios = place order, update profile, view history
    '''
    def def_User(self):
    ...
    '''
    IN = User Details (name, phone, address, password)
    '''
    ...
    #Admins Method Add Food Items in Menu
    ...
    #Admins method to view food items in menu
    ...
    #Admins method to edit food items
    ...
    #User method to place a new order
    '''
    IN = Takes list of items to order
    Operations = Calculate Total amount if order is confirmed by user
    '''
    ...
    #User method to view order history
    ...
    #User method to change or update his profile
